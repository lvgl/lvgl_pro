...
<!-- TODO: Screenshot of the inspector explaining what we see with arrows -->

### Designers and developers work on the same UI

With **LVGL Flow for Figma** you can make the Figma components LVGL aware, then export screens, layouts, styles, data bindings, and navigation straight into the project. No more reimplementing someone else's work in code. Read the [Figma Flow docs](https://lvgl.io/docs/pro/figma).
