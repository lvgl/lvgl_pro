...
<Cards>
  ...
  <Card href="./variants" icon={<Blocks />}>
    **Variants**
  ...
  <Card href="./evaluate" icon={<FileCode />}>
    **Evaluate Expressions**

    Compute an attribute's value from arithmetic, comparisons, ternaries, and string concatenation right in the XML.
  </Card>
  ...
  <Card href="./targets" icon={<Target />}>
    **Multiple Targets**

    Manage multiple variants of your UI with different asset packs and views.
  </Card>
