/**
 * @file lv_example_keyboard_modes_gen.c
...
#include "lv_example_keyboard_modes_gen.h"
...
lv_obj_t * lv_example_keyboard_modes_create(void)
{
    ...
    if (lvgl_open_examples_check_target(LVGL_OPEN_EXAMPLES_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_obj_0, "lv_example_keyboard_modes_#");
        ...
        lv_textarea_set_placeholder_text(textarea, "Type some numbers");
